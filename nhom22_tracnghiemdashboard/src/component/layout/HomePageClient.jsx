        ...
        <div className="flex">
            <div className="basis-1/6">
                <div className="flex items-center text-center ">
                    ...
                    <div className="">
                        <p className="uppercase font-serif">Nhom22</p>
                    </div>
                </div>
                <nav className="">
                    <h1 className="uppercase">Ứng Viên</h1>
                    <li>
                        <Link to={"/thongtin"} about="thontinungvien">Thông tin ứng viên</Link>
                    </li>
                    <h1 className="uppercase">Bài Thi Ứng Tuyển </h1>
                    <li className="flex items-center text-center">
                        ...
                        <Link to={"/dotthi"} about="dottghi">Đợt thi</Link>
                    </li>
                </nav>
            </div>
            <div className="basis-5/6 rounded-2xl">
                ...
                <div className="text-center w-full h-full text-blue-50 items-center bg-[url('./images/back-none.png')] bg-no-repeat bg-cover">
                    <div className="">
                        ...
                        <input type="button" value="Thi Ngay" />
                    </div>
                </div>
            </div>
        </div>
