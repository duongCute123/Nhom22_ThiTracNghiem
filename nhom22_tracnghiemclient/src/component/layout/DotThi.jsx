...
import thi from "../../images/back-dotthi.webp"
...
const DotThi = () => {
    ...
    const [baithi, setBaiThi] = React.useState(false)
    React.useEffect(()=>{
        setBaiThi(false)
    },[])
            ...
            <div className="basis-1/6 mt-10">
                ...
                <nav className="ml-3">
                    ...
                    <li className="flex mt-3 mb-3">
                        ...
                        <Link to={"/profile"} className="text-gray-400 hover:text-gray-600" about="profile">Thông tin ứng viên</Link>
                    </li>
            ...
            <div className="basis-5/6 rounded-2xl mt-10 mr-7">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <MenuItem onClick={handleCloses}>
                                        ...
                                        <Link to={"/login"} about="logout">Logout</Link>
                                    </MenuItem>
                                </Menu>
                            </div>
                        </div>
                ...
                <div className="w-auto h-[500px]">
                    <div className="relative">
                        <img className="w-full h-[200px] bg-cover bg-no-repeat object-cover" src={thi} alt="" />
                        <div className="absolute top-32 ml-3 text-white">
                            <h1 className="uppercase text-2xl font-semibold ">Đợt Thi</h1>
                            <p>Online Exams</p>
                        </div>
                    </div>
                    <div className="text-center items-center">
                        <h1>Danh sách đợt thi</h1>
                        {
                            baithi ?
                                ...
                                :
                                <div className="">
                                    <img className="ml-[440px]" src={logo} alt="" />
                                    <h1>Không có đợt thi nào</h1>
                                    <p>Hiện tại bạn chưa có đợt thi nào trong hệ thống!</p>c
                                    <p>Hệ thống sẽ thông báo khi bạn có tên trong danh sáchc</p>
                                </div>
                        }
                    </div>
                </div>
