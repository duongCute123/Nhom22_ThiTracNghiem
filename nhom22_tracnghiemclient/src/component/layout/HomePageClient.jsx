    ...
    return (
        <div className="flex bg-[#f5f7fa]">
            ...
            <div className="basis-5/6 rounded-2xl mt-10 mr-7">
                ...
                <div className="text-center justify-center w-full h-[500px] text-blue-50 items-center bg-[url('./images/back-none.png')] bg-no-repeat bg-cover">
                    <div className="">
                    ...
                    <div className="">
                        ...
                        <div className="mt-24">
                            ...
                            <input className="mt-6 border-solid rounded-xl w-[200px] h-7 hover:bg-slate-500 bg-slate-200 text-black" type="button" value="Thi Ngay" />
                        </div>
                    </div>
                </div>
            </div>
